...
class BidsParser {
    ...
    private DataflowQueue filesToChannel(List<BidsFile> bidsFiles) {
        ...
        bidsFiles.each { file -> queue << file }
    ...
    static String extractSuffix(String filename) {
        String nameWithoutExt = new BidsFile(filename).getBasename()
