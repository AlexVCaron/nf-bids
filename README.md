...
[![nf-bids](https://img.shields.io/badge/nf&hyphen;bids-0.1.0&hyphen;beta.10-mediumseagreen)](https://registry.nextflow.io/plugins/nf-bids@0.1.0-beta.11-bidsignore)
...
```groovy
plugins {
    id 'nf-bids@0.1.0-beta.11-bidsignore'
}
```
