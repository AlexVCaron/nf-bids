...
Integration tests live under `validation/` and use
...
nf-test test validation/comparison_plain_sets.nf.test --update-snapshot
...
Edge case tests are in `validation/edge_cases/` and target operator
...
Benchmark workflows live in `validation/benchmark/` and compare each
