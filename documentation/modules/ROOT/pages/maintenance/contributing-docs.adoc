...
xref:dependencies/libbids-sh.adoc[the libBIDS.sh dependency chapter];
* validation or test behaviour must update xref:guides/testing.adoc[the testing guide];
* release behaviour must update xref:guides/release.adoc[the release guide].
...
xref:guides/release.adoc[the release guide].
