...
:page-aliases: ROOT:api-reference.adoc
...
See xref:usage:operators/usage.adoc[Channel Operators] for worked examples
and xref:development:source-model/index.adoc[Source model] for the data structures flowing
