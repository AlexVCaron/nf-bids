= Development Guide
:page-aliases: ROOT:guides/development.adoc
...
Start with xref:development:guides/building.adoc[Building & Installation]
...
xref:development:source-model/index.adoc[Source Tree Map]. The most important contributor
areas are:
...
Use the xref:development:guides/testing.adoc[Testing Guide] as the authoritative reference.
...
* xref:development:guides/release.adoc[Release Guide]
...
* xref:development:guides/testing.adoc[Testing Guide]
* xref:development:guides/release.adoc[Release Guide]
* xref:development:source-model/index.adoc[Source Tree Map]
* xref:maintenance/contributing-docs.adoc[Contributing to the Documentation]
