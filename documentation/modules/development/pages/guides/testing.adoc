= Testing Guide
:page-aliases: ROOT:guides/testing.adoc
...
Before running any tests, complete
xref:development:guides/building.adoc[Building & Installation].
After fixing bugs, proceed to the xref:development:guides/release.adoc[Release Guide].
See xref:usage:operators/performance.adoc[Performance Benchmark] for information
...
(see xref:usage:operators/performance.adoc[Performance Benchmark]).
...
See xref:usage:operators/performance.adoc[Performance Benchmark] for the
...
Check the xref:usage:frombids/installation.adoc#prerequisites[Prerequisites] section
