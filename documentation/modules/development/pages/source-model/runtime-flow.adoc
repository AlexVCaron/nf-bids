= Runtime Entry Path
:page-aliases: ROOT:source-model/runtime-flow.adoc
...
image:ROOT:generated/sequence-frombids.svg[fromBIDS sequence]
...
See xref:development:dependencies/libbids-sh.adoc[The libBIDS.sh Dependency] for the full discussion of discovery and bundling.
...
* xref:development:source-model/index.adoc[Source Tree Map] — package table and responsibilities
* xref:development:dependencies/libbids-sh.adoc[The libBIDS.sh Dependency] — discovery order and bundling
* xref:development:concepts/bids-parsing.adoc[BIDS Parsing] — set-type semantics
* xref:usage:frombids/output.adoc[Output Shaping] — flat vs. legacy format
* xref:usage:operators/usage.adoc[Channel Operators] — operator API reference
