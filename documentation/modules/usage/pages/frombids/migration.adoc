...
:page-aliases: ROOT:appendices/migration-bids.adoc
...
All file paths switched to `java.nio.file.Path`. String paths from earlier
versions no longer work directly as Nextflow process inputs.
