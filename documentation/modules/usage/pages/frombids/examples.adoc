...
:page-aliases: ROOT:guides/examples.adoc
...
Start with xref:usage:frombids/installation.adoc[Installation] and
xref:usage:frombids/configuration.adoc[Configuration Loading & Validation] if you need
...
For the legacy tuple format, see xref:usage:frombids/migration.adoc[BIDS Migration Guide].
...
If you are migrating from older output formats, continue with
...
See xref:usage:frombids/configuration.adoc[Configuration Loading & Validation] for
...
* Keep migration-only compatibility logic isolated; see
  xref:usage:frombids/migration.adoc[BIDS Migration Guide] for the legacy
  tuple format.
