...
:page-aliases: ROOT:concepts/channel-operators.adoc
...
See xref:usage:operators/migration.adoc[Closure Operators Migration Guide] for
...
* xref:usage:operators/migration.adoc[Closure Operators Migration Guide]
