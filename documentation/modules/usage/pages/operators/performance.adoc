...
:page-aliases: ROOT:appendices/performance.adoc
...
To reproduce these results, see the xref:development:guides/testing.adoc#layer-3-edge-cases-and-benchmarks[benchmark section of the Testing Guide].
...
See xref:development:guides/testing.adoc#layer-3-edge-cases-and-benchmarks[Testing Guide — Layer 3]
